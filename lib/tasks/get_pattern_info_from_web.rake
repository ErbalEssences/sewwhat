...
namespace :get_pattern_info_from_web do
  ...
  task :send_to_database  => :environment do
    ...
    mccall_brands = [ "voguepatterns"]
    # mccall_brands = ["mccallpattern", "butterick", "voguepatterns"]
    #indie 
    # mccall_search = ["plus-sizes", "misses", "accessories", "aprons", "kids", "family-sleepwear", "swimwear", "costumes", "uniforms", "men", "crafts-dolls-pets", "home-decorating"]
    mccall_search = ["out-of-print"]
